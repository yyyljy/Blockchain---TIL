...
const projectDetail = {
  project1: {
    img: "https://d35ai18pny966l.cloudfront.net/course/kdt/w3/blockchain_1st/600w_home_thumbnail_blockchainschool.png",
    title: "불사 프로젝트",
    contents: [
  ...
  project2: {
    img: "https://news.samsungdisplay.com/wp-content/uploads/2022/03/IT_tc00480001633_final-1024x449.jpg",
    title: "리액트 마스터",
    contents: [
  ...
  project3: {
    img: "https://miro.medium.com/max/4000/0*QpK5ge3amTq1SKKr.jpg",
    title: "스마트 컨트랙트",
    contents: [
...
function onClickOpenModal(projectName) {
  ...
  if (projectDetail[projectName].href) {
    ...
    modalContents.innerHTML += `<li class="mx-2 md:mx-8 mt-2 md:mt-4 text-xs md:text-base">
            <a class="underline text-base md:text-xl text-blue-500" href="${projectDetail[projectName].herf}" target="_blank">사이트 방문하기</a>
        </li>`;
  }
}
